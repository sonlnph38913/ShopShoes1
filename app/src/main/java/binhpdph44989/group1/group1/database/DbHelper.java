...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String dbGiay = "CREATE TABLE GIAY (magiay INTEGER PRIMARY KEY AUTOINCREMENT, tengiay TEXT, hinhanh TEXT, size INTEGER, giaban INTEGER, soluong INTEGER, maloai INTEGER, FOREIGN KEY(maloai) REFERENCES LOAIGIAY(maloai))";
        db.execSQL(dbGiay);
